 ...
 * @author chamod
 */
public class MapResposible extends javax.swing.JFrame {

    /**
     * Creates new form MapResposible
     */
    ...
    public MapResposible() {
        initComponents();
        setFields();
        drawCircle(MoreDetailsRes.x-5, MoreDetailsRes.y-5, MoreDetailsRes.accidentType);
        setIcon();
    }
    ...
    public void setFields(){
        ...
        ddDepartment.setSelectedIndex(MoreDetailsRes.departmentID-1);
        ddColor.setSelectedItem(MoreDetailsRes.accidentType);
        try {
            ImportImage(MoreDetailsRes.departmentID-1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MapResposible.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MapResposible().setVisible(true);
            }
        });
    }
